...
extension Character {
    ...
    func getKoreanJungSeong() -> String?{
        ...
        value = Character.koreanChoSeongs[Int(idx_jung)];
    ...
    func getKoreanJongSeong() -> String?{
        ...
        let uIndex = self.getKoreanIndex()!;
        let idx_jong = uIndex % UInt32(Character.koreanJungSeongs.count * Character.koreanJongSeongs.count);
        
        value = Character.koreanChoSeongs[Int(idx_jong)];
